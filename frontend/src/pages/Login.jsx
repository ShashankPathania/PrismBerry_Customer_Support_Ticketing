    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 via-white to-primary-100 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-surface-500 mt-2">Customer Support Desk</p>
        </div>
        ...
        <div className="mt-6 p-4 bg-white/60 backdrop-blur-sm rounded-xl border border-surface-200 text-center">
          ...
          <p className="text-xs text-surface-600">
            <span className="font-medium">Agent:</span> tech@example.com
          </p>
